...
- (void)declineUser:(XMPPJID *)jid withMessage:(NSString *)declineMessageStr
{
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		if ([declineMessageStr length] > 0)
		{
			[decline addChild:[NSXMLElement elementWithName:@"reason" stringValue:declineMessageStr]];
		}
