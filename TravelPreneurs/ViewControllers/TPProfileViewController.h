...
@interface TPProfileViewController : UIViewController <UITextFieldDelegate, UIGestureRecognizerDelegate>
@property (strong, nonatomic) IBOutlet UIImageView *businessIconImageView;
@property (strong, nonatomic) IBOutlet UIImageView *managerIconImageView;
@property (strong, nonatomic) IBOutlet UIImageView *emailIconImageView;
@property (strong, nonatomic) IBOutlet UIView *mFirstUnderLine;
...
@property (strong, nonatomic) IBOutlet NSLayoutConstraint *mManagerIconTopSpacingConstant;
